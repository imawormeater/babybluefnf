...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-gone':
				tex = Paths.getSparrowAtlas('gfGone');
				frames = tex;
			...
			case 'baby':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('baby/baby','shared');
				frames = tex;
			...
			case 'miku':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('baby/ev_miku_assets','shared');
				frames = tex;
			...
			case 'tinky':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('baby/Tinky_Winky','shared');
				frames = tex;
			...
			case 'pewdiepie':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('baby/pewdiepie','shared');
				frames = tex;
			...
			case 'freddy':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('baby/freddy','shared');
				frames = tex;
			...
			case 'scout':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('baby/scout','shared');
				frames = tex;
			...
			case 'homer':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('baby/homer','shared');
				frames = tex;
			...
			case 'monstershit':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('baby/monsterShit','shared');
				frames = tex;
